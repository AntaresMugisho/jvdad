...
export default function MyTextEditor({ data, onChange, post }: Props) {
  ...
  return (
    <div
      id="editorjs"
      className="border border-slate-300 overflow-scroll prose prose-lg max-w-none prose-headings:text-slate-900 prose-p:text-slate-700 prose-a:text-emerald-600 prose-strong:text-slate-900 prose-img:rounded-xl prose-img:shadow-lg  h-[60vh] rounded-md p-3"
    />
  );
}
